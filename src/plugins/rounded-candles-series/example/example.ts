...
import { CandleData, generateAlternativeCandleData } from '../../../../vendor/lw-charts/plugin-examples/src/sample-data.ts';
import { RoundedCandleSeries } from '../rounded-candles-series.ts';
